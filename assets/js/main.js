(() => {
  ...
  if (reducedMotion.matches) {
    ...
    const revealTargets = $$(".experience__head > *, .experience__item, .paper__page, .paper__copy, .topd-frontier__kicker, .topd-frontier__statement, .topd-frontier__copy, .section-head, .adoption-paper, .demo, .fpo-label, .contact__inner > *");
